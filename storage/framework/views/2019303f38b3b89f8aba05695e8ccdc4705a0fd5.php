<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo e(route('admin.dashboard')); ?>" class="brand-link">
        <img src="<?php echo e(asset('assets/admin/dist/img/AdminLTELogo.png')); ?>" alt="Logo"
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview"
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.verifications.index')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('admin.verifications.*') ? 'active' : ''); ?>">
                        <i class="fas fa-id-card nav-icon"></i>
                        <p><?php echo e(__('messages.Identity_Verifications')); ?></p>
                    </a>
                </li>

                
                <li class="nav-header"><?php echo e(__('messages.matching_moderation')); ?></li>

                <li class="nav-item">
                    <a href="<?php echo e(route('admin.match-requests.index')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('admin.match-requests.*') ? 'active' : ''); ?>">
                        <i class="fas fa-heart nav-icon"></i>
                        <p><?php echo e(__('messages.Match_Requests')); ?></p>
                    </a>
                </li>

                <li class="nav-item">
                    <a href="<?php echo e(route('admin.conversations.index')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('admin.conversations.*') ? 'active' : ''); ?>">
                        <i class="fas fa-comments nav-icon"></i>
                        <p><?php echo e(__('messages.Conversations')); ?></p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.reports.index')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('admin.reports.*') ? 'active' : ''); ?>">
                        ...
                        <p><?php echo e(__('messages.Reports')); ?></p>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.matchmakers.index')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('admin.matchmakers.*') ? 'active' : ''); ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.consultants.index')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('admin.consultants.*') ? 'active' : ''); ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.private-requests.index')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('admin.private-requests.*') ? 'active' : ''); ?>">
                ...
                <li class="nav-header"><?php echo e(__('messages.notifications')); ?></li>
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.interests.index')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('admin.interests.*') ? 'active' : ''); ?>">
                        <i class="fas fa-tags nav-icon"></i>
                        <p><?php echo e(__('messages.Interests')); ?></p>
                    </a>
                </li>

                <li class="nav-item">
                    <a href="<?php echo e(route('admin.guided-questions.index')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('admin.guided-questions.*') ? 'active' : ''); ?>">
                        <i class="fas fa-question-circle nav-icon"></i>
                        <p><?php echo e(__('messages.Guided_Questions')); ?></p>
                    </a>
                </li>
...
<?php /**PATH C:\xampp\htdocs\neyyah\resources\views/admin/includes/sidebar.blade.php ENDPATH**/ ?>