...
@section('title', __('messages.New_Interest'))
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{ __('messages.New_Interest') }}</li>
                    </ol>
                </div>
                <h4 class="page-title">{{ __('messages.New_Interest') }}</h4>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.interests.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <small class="text-muted">Emoji or icon class name</small>
                        </div>
